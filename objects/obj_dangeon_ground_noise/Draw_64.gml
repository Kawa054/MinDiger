...
if (surface_exists(application_surface)){
	switch(global.dangeon_type){
		...
		case DANGEON_TYPE_VOLCANO:
			shader_set_uniform_f(unf_gc_r, DANGEON_GROUND2_COLOR_R);
			shader_set_uniform_f(unf_gc_g, DANGEON_GROUND2_COLOR_G);
			shader_set_uniform_f(unf_gc_b, DANGEON_GROUND2_COLOR_B);
			shader_set_uniform_f(unf_nc_r1, DANGEON_GROUND2_NOISE1_COLOR_R/255.0);
			shader_set_uniform_f(unf_nc_g1, DANGEON_GROUND2_NOISE1_COLOR_G/255.0);
			shader_set_uniform_f(unf_nc_b1, DANGEON_GROUND2_NOISE1_COLOR_B/255.0);
			shader_set_uniform_f(unf_nc_r2, DANGEON_GROUND2_NOISE2_COLOR_R/255.0);
			shader_set_uniform_f(unf_nc_g2, DANGEON_GROUND2_NOISE2_COLOR_G/255.0);
			shader_set_uniform_f(unf_nc_b2, DANGEON_GROUND2_NOISE2_COLOR_B/255.0);
		break;
	}
